function RossbyHaurwitzWaveOutputs!(rossby_haurwitz_wave_simulation;
    ...
    rossby_haurwitz_wave_simulation.output_writers[:checkpointer] = Checkpointer(
    ...
    outputs = (; u = rossby_haurwitz_wave_model.velocities.u, v = rossby_haurwitz_wave_model.velocities.v,
                 η = rossby_haurwitz_wave_model.free_surface.η)
    output_filename = "rossby_haurwitz_wave_output"
    rossby_haurwitz_wave_simulation.output_writers[:output] = JLD2Writer(
        rossby_haurwitz_wave_model, outputs;
        dir = output_directory,
